...
const TermsAndConditions = () => {
  useEffect(() => {
    ...
    document.title = 'Terms and Conditions | Orange Cabs';
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Read Orange Cabs terms and conditions for bookings, payments, waiting time, cancellations, and trip changes. Contact our team for help with any booking questions.');
    }

    const ogTitle = document.querySelector('meta[property="og:title"]');
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Terms and Conditions | Orange Cabs');
    }

    const ogDescription = document.querySelector('meta[property="og:description"]');
    if (ogDescription) {
      ogDescription.setAttribute('content', 'Read Orange Cabs terms and conditions for bookings, payments, waiting time, cancellations, and trip changes. Contact our team for help with any booking questions.');
    }

    const ogImageAlt = document.querySelector('meta[property="og:image:alt"]');
    if (ogImageAlt) {
      ogImageAlt.setAttribute('content', 'Orange Cabs terms and conditions');
    }

    const twitterTitle = document.querySelector('meta[name="twitter:title"]');
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Terms and Conditions | Orange Cabs');
    }

    const twitterDescription = document.querySelector('meta[name="twitter:description"]');
    if (twitterDescription) {
      twitterDescription.setAttribute('content', 'Read Orange Cabs terms and conditions for bookings, payments, waiting time, cancellations, and trip changes. Contact our team for help with any booking questions.');
    }
  }, []);
              ...
              <CardContent className="space-y-4">
                <div>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1">
                    <li>No refund is applicable for any cancellation of bookings</li>
                    <li>However, the full amount can be redeemed on the same service within 365 days of the original trip date</li>
                    <li>Multi-Day Trip: No refunds, full amount redeemable within 365 days</li>
                    <li>Single Day trip/ Airport transfer: No refunds, full amount redeemable within 365 days</li>
                    <li>The redeemed amount must be used for the same type of service as originally booked</li>
                  </ul>
                </div>
