      ...
      <div className="pt-8 md:pt-16 pb-8 md:pb-16 px-4">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 lg:order-1 order-2">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-black mb-6 flex items-center gap-2">
                <Home className="w-6 h-6 text-orange-500" /> Spiritual Sanctuaries
              </h2>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-black mb-6 flex items-center gap-2">
                <Mountain className="w-6 h-6 text-orange-500" /> Nature & Wildlife
              </h2>
              <p className="text-gray-700 mb-6">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-black mb-6 flex items-center gap-2">
                <Building className="w-6 h-6 text-orange-500" /> Museums & Culture
              </h2>
              <p className="text-gray-700 mb-6">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-black mb-6 flex items-center gap-2">
                <Sparkles className="w-6 h-6 text-orange-500" /> Family & Recreation
              </h2>
              <p className="text-gray-700 mb-6">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-black mb-6 flex items-center gap-2">
                <Building className="w-6 h-6 text-orange-500" /> Shopping & Lifestyle
              </h2>
              <p className="text-gray-700 mb-6">
          ...
          <div className="w-full lg:w-80 lg:order-2 order-1">
            {/* Table of Contents */}
            <div className="bg-white border border-gray-300 rounded-lg p-4 md:p-6 mb-6 md:mb-8">
              ...
              <ul className="space-y-2 md:space-y-3 text-xs md:text-sm">
                <li><a href="#spiritual" className="text-gray-700 hover:text-orange-400 transition-colors">Spiritual Sanctuaries</a></li>
            ...
            <div className="bg-white border border-gray-300 rounded-lg p-4 md:p-6 mb-6 md:mb-8">
              <h3 className="text-base md:text-lg font-semibold text-black mb-3 md:mb-4 flex items-center gap-2">
                <Share2 className="w-4 h-4 md:w-5 md:h-5 text-orange-500" /> SHARE
              </h3>
              <div className="flex gap-2 md:gap-3">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 bg-gray-700 hover:bg-gray-600 rounded-lg flex items-center justify-center transition-colors">
                  <Facebook className="w-3 h-3 md:w-4 md:h-4 text-white" />
                </a>
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 bg-gray-700 hover:bg-gray-600 rounded-lg flex items-center justify-center transition-colors">
                  <Twitter className="w-3 h-3 md:w-4 md:h-4 text-white" />
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 bg-gray-700 hover:bg-gray-600 rounded-lg flex items-center justify-center transition-colors">
            ...
            <div className="bg-white border border-gray-300 rounded-lg p-4 md:p-6">
              <h3 className="text-base md:text-lg font-semibold text-black mb-3 md:mb-4">POPULAR READS</h3>
              <div className="space-y-3 md:space-y-4">
                <a href="#" className="block text-xs md:text-sm text-gray-700 hover:text-orange-400 transition-colors">
                  The Ultimate Food Guide to Guwahati
                </a>
                <a href="#" className="block text-xs md:text-sm text-gray-700 hover:text-orange-400 transition-colors">
                  5 Hidden Waterfalls Near the City
                </a>
                <a href="#" className="block text-xs md:text-sm text-gray-700 hover:text-orange-400 transition-colors">
                  Cultural Festivals of Assam You Can't Miss
                </a>
              </div>
            </div>
          </div>
